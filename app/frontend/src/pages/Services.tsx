      ...
      <section className="relative py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-16 lg:grid-cols-12 items-center">
          <div className="lg:col-span-7">
            ...
            {/* Adresler panelden geliyor; footer ve iletişim ile aynı kaynak. */}
            <SocialLinks variant="pill" />
          </div>

          <div className="lg:col-span-5 relative">
            {/*
              Künye kartı artık iki satırlı bir sütun.
              Eskiden ad kutusu `absolute bottom-6` ile görselin üstüne
              biniyor ve logonun alt bandındaki yazıyı kesiyordu. Şimdi
              görselin kendi alanı var, ad kutusu onun altında normal akışta
              duruyor; hiçbir koşulda üst üste gelmiyorlar.
            */}
            <div className="relative flex flex-col gap-4 rounded-3xl glass p-4 animate-float">
              <div className="absolute -inset-4 bg-gradient-to-br from-purple-500/30 via-pink-500/20 to-cyan-500/20 blur-2xl -z-10" />
              <div className="flex aspect-square items-center justify-center overflow-hidden rounded-2xl bg-white/[0.02] p-4">
                <img
